...
#'                for Setup - II, when the parametric model is correctly specified.
...
btsimu_exp<-function(I=1000,J=1000,n1=50,n0=50,rate_t = 0.4, rate_c = 1,seed1=1000){
  res0=c()
  for (i in 1:I)
  {
...
write.csv(output, "F:/Output/Setup 2/Para_Spec/Semiparametric/BS-CI/C3T_CI_400.csv")
