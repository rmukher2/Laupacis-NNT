...
#'                Delta based CI for Setup - II, when the parametric model is correctly specified.
...
##################################################################################################################
  ...
  # Coverage
  cov_dl[i] <- ifelse(ci_dr[[i]][1] <= 3.21 & ci_dr[[i]][2] >= 3.21, 1, 0)
  ...
  write.csv(output, "F:/Output/Setup 2/Para_Spec/Semiparametric/PE/C3T_800.csv")
