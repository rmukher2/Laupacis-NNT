...
#median(NNT_D)
median(delta_diff, na.rm = T)       # median of delta difference
mean(cov_dl, na.rm = T)             # Coverage of delta difference
...
write.csv(output, "F:/Output/Setup 2/Para Misspecified/Semiparametric/PE/C3T_800.csv")
