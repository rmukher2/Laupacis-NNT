...
#' @Description - Obtain the BS CI for Nonparametric Laupacis NNT for Setup - II, when the semiparametric model
#'                is misspecified.
...
## Coverage
coverage[i] <- ifelse(ci_bs[[i]][1] <= 5.47 & ci_bs[[i]][2] >= 5.47, 1, 0)
}
...
write.csv(output, "F:/Output/Setup 2/SP_MIS/Try 2/Nonpara/CI/C3T_CI_800.csv")
